...
public class DemoUsoEmpleado {
	...
	public static void main(String[] args) {
		...
		// paso 2
		// solicitarle el beans al archivo xml , pasandole el alias o id , y en segundo
		// lugar
		...
		// la ventaja de esto es que ahora podemos reutilizarlo en otra clase
		// como por ejemplo JefeEmpleado.java
